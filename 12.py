def count_hole_letters_in_word(word: str, hole_chars: set):
    """Вспомогательная функция, которая подсчитывает количество букв с отверстиями в одном слове.
    
    Параметры:
    word (str) слово, в котором нужно подсчитать буквы с отверстиями
    hole_chars (set) множество символов, которые считаются буквами с отверстиями
    
    Возвращает:
    int количество букв в слове, которые присутствуют в множестве hole_chars
    """
